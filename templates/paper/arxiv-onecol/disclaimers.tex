% disclaimers.tex — the RWI disclaimer catalogue, rendered.
% Shared \input by main.tex Section "Limitations". Typed and enumerable,
% not ad hoc prose. IDs are the semantic ids of the single disclaimer
% catalogue (methodology/data/disclaimer_catalogue.json per Chair Ruling v1
% §C2) -- there is no numeric D1-D12 scheme in this repo. See
% design/S5_paper-and-academic-templates.md Part 2 for the canonical
% definition of each item and which are mandatory per genre, and
% design/CHAIR_RULING_v1.md §A2/§C2 for the id-scheme ruling. Fill every
% [FILL]; write "none identified" rather than deleting an item.
